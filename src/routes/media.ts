...
router.get('/stats', MediaFileController.getMediaStats);

// Get recent media files
router.get('/recent', MediaFileController.getRecentMediaFiles);

// Search media files
router.get('/search', MediaFileController.searchMediaFiles);

// Get media files by type
router.get('/type/:type', MediaFileController.getMediaFilesByType);
...
router.get('/:mediaId', MediaFileController.getMediaFileById);

// Update media file
router.put('/:mediaId', MediaFileController.updateMediaFile);

// Delete media file
router.delete('/:mediaId', MediaFileController.deleteMediaFile);
